...
void Scene::preProcess() {
	...
	setupObject(objPro, gunbot, "Gun_Bot.obj", 0.20f, true);
	setupObject(objPro, spaceship, "spaceship.obj", 0.08f);
...
void Scene::draw(GLFWwindow* window) {
	if (mode == Start) {
		...
		stagerot += 1.0f;
		glm::mat4 spaceship_vs =
			glm::translate(glm::identity<glm::mat4>(), glm::vec3(-0.5f, -0.0f, -1.0f))
			* glm::rotate(glm::radians(stagerot), glm::vec3(0.0f, 1.0f, 0.0f))
			* glm::rotate(glm::radians(-45.0f), glm::vec3(0.0f, 0.0f, 1.0f))
			* glm::translate(glm::identity<glm::mat4>(), glm::vec3(0.0f, 0.0f, 0.3f));
		glm::mat4 gunbot_vs = glm::translate(glm::identity<glm::mat4>(), glm::vec3(0.5f, -0.15f, -1.0f))
			* glm::rotate(glm::radians(-stagerot), glm::vec3(0.0f, 1.0f, 0.0f));
